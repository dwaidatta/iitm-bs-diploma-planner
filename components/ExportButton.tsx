    ...
    try {
      ...
      exportDiv.innerHTML = `
              ...
              <div style="background: #1e293b; border: 2px solid #334155; border-radius: 12px; padding: 24px;">
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; padding-bottom: 16px; border-bottom: 2px solid #334155;">
                  ...
                  <div style="display: flex; gap: 8px;">
                    <span style="padding: 4px 12px; background: #334155; border-radius: 6px; font-size: 13px; color: #cbd5e1;">
                    ...
                    ${oppeCount > 0 ? `
                      <span style="padding: 4px 12px; background: #7f1d1d; border: 1px solid #991b1b; border-radius: 6px; font-size: 13px; color: #fca5a5;">
                        ${oppeCount} OPPE
                      </span>
                    ` : ''}
                  </div>
                  ...
                  return `
                    <div style="margin-bottom: 16px; padding: 16px; background: #0f172a; border-radius: 8px; border-left: 4px solid ${borderColor};">
                      ...
                      <div style="display: flex; gap: 8px; margin-bottom: 8px; flex-wrap: wrap;">
                        <span style="padding: 2px 8px; background: ${bgColor}; border-radius: 4px; font-size: 12px; color: #e2e8f0;">
                          ${course?.code}
                        </span>
                        <span style="padding: 2px 8px; background: #334155; border-radius: 4px; font-size: 12px; color: #cbd5e1;">
                          ${course?.credits} ${course?.credits === 1 ? 'credit' : 'credits'}
                        </span>
                        ${course?.hasOPPE ? `
                          <span style="padding: 2px 8px; background: #7f1d1d; border: 1px solid #991b1b; border-radius: 4px; font-size: 12px; color: #fca5a5;">
                            OPPE
                          </span>
                        ` : ''}
                        ${course?.hasQuiz ? `
                          <span style="padding: 2px 8px; background: #1e3a8a; border: 1px solid #1e40af; border-radius: 4px; font-size: 12px; color: #93c5fd;">
                            Quiz
                          </span>
                        ` : ''}
                        ${course?.isProject ? `
                          <span style="padding: 2px 8px; background: #581c87; border: 1px solid #6b21a8; border-radius: 4px; font-size: 12px; color: #e9d5ff;">
                            Project
                          </span>
                        ` : ''}
                      </div>
        ...
        <div style="margin-top: 32px; padding-top: 20px; border-top: 2px solid #334155; text-align: center; color: #64748b; font-size: 14px;">
          <p>Generated by IIT Madras Diploma Planner • Plan your journey term by term</p>
        </div>
      `;
